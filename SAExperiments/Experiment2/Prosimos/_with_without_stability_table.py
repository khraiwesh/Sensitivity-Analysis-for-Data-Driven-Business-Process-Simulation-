...
gateways (Sobol ST). For each condition separately, averages the seed-pair
mean agreement across all sample sizes N (from
prosimos_seed_stability/seed_agreement_ST.csv), then reports whether removing
...
AGREEMENT_CSV = ROOT / "prosimos_seed_stability" / "seed_agreement_ST.csv"
...
def main():
    ...
    # average the per-N mean seed-pair agreement across all sample sizes
    ...
    out_csv = ROOT / "prosimos_seed_stability" / "with_vs_without_stability_table.csv"
    ...
    out_path = ROOT / "prosimos_seed_stability" / "with_vs_without_stability_table.png"
