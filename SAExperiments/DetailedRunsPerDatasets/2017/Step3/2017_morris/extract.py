...
for folder in BASE_DIR.iterdir():
    ...
    # final_wo_gateways_2012_morris_100_512_no2nd
    if not folder.name.startswith("final_wo_gateways_") or "_morris_" not in folder.name:
        continue

    parts = folder.name.split("_")
    # ["final", "wo", "gateways", "2012", "morris", "100", "512", "no2nd"]
