...
SA_RANKINGS = {
    ...
    # DataMining (ACR / ConsultaDataMining201618) reference rankings, from
    # the stability analysis run on gateway-excluded Sobol (n=2048) and
    # Morris (t=512) results. Both methods produced the IDENTICAL 5-group
    # ranking here (rho=1.000 between them), an unusually clean result.
    "datamining": {
        "sobol":  {"RC": 1, "AC": 2, "AD": 3, "RN": 4, "TR": 5},
        "morris": {"RC": 1, "AC": 2, "AD": 3, "RN": 4, "TR": 5},
    },
}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["2012", "2017", "2013", "2012_v3", "2017_v3", "2013_v3",
                 "production", "production_v3", "datamining", "datamining_v3"],
        required=True,
    )
